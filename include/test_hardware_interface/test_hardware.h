#ifndef ROS_CONTROL__TEST_HARDWARE_H
#define ROS_CONTROL__TEST_HARDWARE_H
...
namespace test_hardware_interface
{
	...
	class testHardware : public hardware_interface::RobotHW
	{
	    protected:
		// Interfaces
		...
		joint_limits_interface::PositionJointSoftLimtsInterface position_joint_limits_interface_;
		...
		//Custom / available transmissions
